...
public class fragmentMensCasual extends Fragment {
    private static final String TAG = "fragmentMensCasual";

    static String web_url = "https://www.academy.com/shop/browse/footwear/mens-footwear/mens-casual-shoes";
    static int item = 0;
    TextView text;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mens_casual,container,false);

        new UpdateProductInfo().execute();
        updateSettingList();
