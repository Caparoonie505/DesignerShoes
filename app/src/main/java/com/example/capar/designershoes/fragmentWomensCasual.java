...
public class fragmentWomensCasual extends Fragment {
    private static final String TAG = "fragmentWomensCasual";

    static String web_url = "https://www.academy.com/shop/browse/footwear/womens-footwear/womens-casual-shoes";
    static int item = 0;
    TextView text;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_womens_casual,container,false);

        new fragmentWomensCasual.UpdateProductInfo().execute();
        updateSettingList();
