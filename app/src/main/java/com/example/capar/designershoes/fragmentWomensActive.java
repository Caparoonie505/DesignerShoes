...
public class fragmentWomensActive extends Fragment {
    private static final String TAG = "fragmentWomensActive";

    static String web_url = "https://www.academy.com/shop/browse/footwear/womens-footwear/womens-athletic-sneakers";
    static int item = 0;
    TextView text;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_womens_active,container,false);

        new fragmentWomensActive.UpdateProductInfo().execute();
        updateSettingList();
